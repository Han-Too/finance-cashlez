                    ...
                    <div class="scroll-y me-n7 pe-7">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Place your name"
                                name="username" value="<?php echo e($data->username); ?>" required />
                            <!--end::Input-->
                        </div>
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <select name="role_id" aria-label="Select a Role" 
                                ...
                                <?php $__currentLoopData = $role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option
                                    <?php if($mod->role_id == $item->id): ?>
                                        selected
                                    <?php endif; ?>
                                    value="<?php echo e($item->name); ?>"><?php echo e($item->name); ?></option>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\finance-server\resources\views/modules/users/edit.blade.php ENDPATH**/ ?>