...
<div class="modal fade" id="kt_modal_new_target" tabindex="-1" aria-hidden="true">
                ...
                <form id="store_bank_form" class="form" action="#">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <select name="bank_id" aria-label="Select a Channel"
                            ...
                            <?php $__currentLoopData = $channel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <!--end::Modal dialog-->
</div><?php /**PATH C:\laragon\www\finance-server\resources\views//modules/parameters/create-modal.blade.php ENDPATH**/ ?>