                            ...
                            <p class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                                ...
                                <div class="d-flex flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                    <div class="me-2">
                                        ...
                                        <span class="text-dark fw-bold"><?php echo e($resmatch); ?> Trx</span>
                                    </div>
                            ...
                            <p class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                                ...
                                <div class="d-flex flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                    <div class="me-2">
                                        ...
                                        <span class="text-dark fw-bold"><?php echo e($resdispute); ?> Trx</span>
                                    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\finance-server\resources\views/modules/reconcile/show.blade.php ENDPATH**/ ?>