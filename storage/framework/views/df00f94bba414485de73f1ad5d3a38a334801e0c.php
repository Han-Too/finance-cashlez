...
<?php $component->withAttributes([]); ?>
    <div class="container">
        <div class="card card-flush px-10 py-6 rounded-sm">
            ...
            <!--begin::Datatable-->
            <table id="aktivasi" class="table align-middle table-row-dashed fs-6 gy-5">
                <thead>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\finance-server\resources\views/modules/users/aktivasi.blade.php ENDPATH**/ ?>