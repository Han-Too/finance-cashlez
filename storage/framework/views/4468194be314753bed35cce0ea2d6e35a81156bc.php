            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link <?php echo e(request()->is('reconcile') ? 'active' : ''); ?>" href="<?php echo e(url('reconcile')); ?>">
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php echo e(request()->is('reconcile/partner') ? 'active' : ''); ?>" href="<?php echo e(url('reconcile/partner')); ?>">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <?php if($privDis->read): ?>
                    <div class="menu-item">
                        <a class="menu-link" href="<?php echo e(url('disbursement')); ?>">
                            <span class="menu-icon">
