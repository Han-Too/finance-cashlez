                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <div class="mb-0 w-100 me-1">
                            <input class="form-control form-control-solid" placeholder="Pick date rage"
                                id="kt_daterangepicker_3" name="bo_date" />
                        </div>
                    </div>
                    <!--end::Input group-->
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <div class="mb-0 w-100 me-1">
                            <input class="form-control form-control-solid" placeholder="Pick date rage"
                                id="kt_daterangepicker_4" name="bs_date" />
                        </div>
                    </div>
                    <!--end::Input group-->
...
<?php /**PATH C:\laragon\www\finance-server\resources\views//modules/reconcile/detail/reconcile-modal.blade.php ENDPATH**/ ?>