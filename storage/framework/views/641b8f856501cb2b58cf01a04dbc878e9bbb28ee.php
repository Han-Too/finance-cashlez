...
<?php $component->withAttributes([]); ?>
            ...
            <div class="d-flex flex-wrap justify-content-between">
                ...
                <div class="d-flex flex-wrap">
                    <div class="border border-gray-300 border-dashed rounded  w-300px py-3 px-4 me-6 mb-3">
                        <a href=<?php echo e(url('/reconcile/result?status=match&token='.$token)); ?>
                            ...
                            <div class="d-flex flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
                                    ...
                                    <span class="text-gray-400 fw-bold"><?php echo e($match); ?> Trx</span>
                                </div>
                                <div class="fw-bolder fs-5 text-primary">IDR Rp. <?php echo e(number_format($sumMatch)); ?></div>
                            </div>
                            <!--end::Hidden-->
                        </a>
                    </div>
                    <div class="border border-gray-300 border-dashed rounded  w-300px py-3 px-4 me-6 mb-3">
                        <a href=<?php echo e(url('/reconcile/result?status=dispute&token='.$token)); ?>
                            ...
                            <div class="d-flex flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
                                    ...
                                    <span class="text-gray-400 fw-bold"><?php echo e($dispute); ?> Trx</span>
                                </div>
                                <div class="fw-bolder fs-5 text-primary">IDR Rp. <?php echo e(number_format($sumDispute)); ?></div>
                            </div>
                            <!--end::Hidden-->
                        </a>
                    </div>
                    <div class="border border-gray-300 border-dashed rounded  w-300px py-3 px-4 me-6 mb-3">
                        <a href=<?php echo e(url('/reconcile/result?status=onHold&token='.$token)); ?>
                            ...
                            <div class="d-flex flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
                                    ...
                                    <span class="text-gray-400 fw-bold"><?php echo e($onHold); ?> Trx</span>
                                </div>
                                <div class="fw-bolder fs-5 text-primary">IDR Rp. <?php echo e(number_format($sumHold)); ?></div>
                            </div>
                            <!--end::Hidden-->
                        </a>
                    </div>
    ...
    <?php $__env->startSection('scripts'); ?>
        <script src="<?php echo e(asset('cztemp/assets/custom/js/reconcile.js')); ?>"></script>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/modules/reconcile/show.blade.php ENDPATH**/ ?>