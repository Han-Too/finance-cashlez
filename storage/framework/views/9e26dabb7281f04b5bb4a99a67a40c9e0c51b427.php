...
<?php $component->withAttributes([]); ?>
                    ...
                    <div class="d-flex align-items-center  flex-wrap">
                        <?php if($status == 'debit'): ?>
                            ...
                            <div class=" w-50 py-1 px-2 mb-3">
                                <a href="/settlement/detail/<?php echo e($token); ?>"
                            ...
                            <div class="border border-gray-300 border-dashed rounded  w-50 py-1 px-2 mb-3">
                                <span class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                                    ...
                                    <div class="d-flex flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                        ...
                                        <div class="fw-bolder fs-5 text-primary">IDR Rp.
                                            <?php echo e(number_format($sumCredit)); ?>
    ...
    <?php $__env->startSection('scripts'); ?>
        <script src="<?php echo e(asset('cztemp/assets/custom/js/reconcile_detailstatus.js')); ?>"></script>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\finance-server\resources\views/modules/reconcile/detail/status.blade.php ENDPATH**/ ?>