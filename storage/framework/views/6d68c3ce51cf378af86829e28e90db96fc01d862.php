...
<?php $component->withAttributes([]); ?>
        ...
        <div class="card card-flush px-10 py-6 rounded-sm">
            ...
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    <?php if(auth()->user()->hasAnyPermission(['create-reconlist'])): ?>
    ...
    <?php echo $__env->make('modules.reconcile.list.modal_recon', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\finance-server\resources\views/modules/reconcile/list/list.blade.php ENDPATH**/ ?>