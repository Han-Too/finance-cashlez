                ...
                <form id="store_settlement_form" class="form" action="#">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Settlement Name</span>
                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                title="Name of the bank"></i>
                        </label>
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid"     
                        name="settlename" id="" value="Settlement-<?php echo e(\Carbon\Carbon::now()); ?>">
                    </div>
                    ...
                    <div class="d-flex flex-stack w-100 mb-8">
                        <!--begin::Label-->
                        <div class="me-5">
                            <label class="fs-6 fw-bold form-label">Partner Report</label>
                            <div class="fs-7 fw-bold text-muted">check if you want to add the partner report</div>
                        </div>
                        <!--end::Label-->
                    
                        <!--begin::Switch-->
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" id="partnerReport" value="0" onclick="addPartnerReport()"/>
                        </label>
                        <!--end::Switch-->
                    </div>
                    ...
                    <div class="fv-row mb-8" id="dropzonePartnerReport" style="display: none">
                        <!--begin::Dropzone-->
...
<?php /**PATH C:\laragon\www\finance-server\resources\views//modules/settlement/create-modal.blade.php ENDPATH**/ ?>