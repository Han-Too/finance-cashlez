...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container">
        <div class="card card-flush px-10 py-6 rounded-sm">
            ...
            <form class="form"  id="add_role_form" >
                <?php echo csrf_field(); ?>
                    ...
                    <div class="scroll-y me-n7 pe-7">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" class="form-control form-control-solid" id="named"
                                placeholder="Place role's title" name="name" required />
                            <!--end::Input-->
                        </div>
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\finance-server\resources\views/modules/roles/add.blade.php ENDPATH**/ ?>