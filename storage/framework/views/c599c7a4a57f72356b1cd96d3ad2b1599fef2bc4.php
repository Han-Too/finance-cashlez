<div class="tab-pane fade show" id="nav-unmatch" role="tabpanel" aria-labelledby="nav-unmatch-tab" tabindex="0">
    <!--begin::Header-->
    <div class="card-header border-0 py-5 rounded-sm mb-5">
        ...
        <div class="row gy-3 g-xl-8">
            <div class="col-xl-12">
                <table  id="dataTable" class="table align-middle table-row-dashed fs-6 gy-5">
                    <thead>
                        <tr class="text-start text-dark fw-bolder fs-7 text-uppercase gs-0 border-bottom border-dark">
                            ...
                            <th class="">Bank Movement (BS)</th>
                            <th class="">Total Movement (BS)</th>
                            <th class="">Transfer Date</th>
                            <th class="">Bank Transfer (BO)</th>
                            <th class="">Total Transfer (BO)</th>
                            <th class="">Movement Date</th>
                ...
                <div id="moneyList">
                    <!-- Daftar uang akan ditambahkan di sini -->
                </div>
                <div id="savingList">
                    <!-- Daftar tabungan akan ditambahkan di sini -->
                </div>
                ...
                <div class="d-flex mb-2 align-items-center">
                    <div class="mb-0 w-75 me-1">
                        <div class="d-flex align-items-center position-relative w-100">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" id="searchBank" class="form-control form-control-solid ps-14"
                                placeholder="Search Table" />
                        </div>
                    </div>
                    <div class="mb-0 w-25 ms-1">
                        <button id="clearBankSearch" class="btn btn-sm btn-light-warning w-100">Clear
                            Search</button>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex mb-2 align-items-center">
                    <div class="mb-0 w-75 me-1">
                        <div class="d-flex align-items-center position-relative w-100">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" id="searchBO" data-kt-docs-table-filter="searchBo"
                                class="form-control form-control-solid ps-14" placeholder="Search Table" />
                        </div>
                    </div>
                    <div class="mb-0 w-25 ms-1">
                        <button id="clearBoSearch" class="btn btn-sm btn-light-warning w-100">Clear
                            Search</button>
                    </div>
                </div>
            </div>
                        ...
                        <table id="bank_settlement_table" class="table align-middle table-row-dashed fs-6 gy-5">
                            <thead>
                                <tr class="text-start text-dark fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th><input type="checkbox" class="form-check-input" id="checkAllBS"></th>
                                </tr>
                            </thead>
                            <tbody class="text-gray-600 fw-bold">
                            </tbody>
                        ...
                        <table id="bo_settlement_table" class="table align-middle table-row-dashed fs-6 gy-5">
                            <thead>
                                <tr class="text-start text-dark fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th>MID</th>
                                    <th>Bank Payment</th>
                                    <th><input type="checkbox" class="form-check-input" id="checkAllBO"></th>
                                </tr>
                            </thead>
                            <tbody class="text-gray-600 fw-bold">
                            </tbody>
...
<?php /**PATH C:\laragon\www\finance-server\resources\views/modules/reconcile/list/tabs/tabunmatch.blade.php ENDPATH**/ ?>