                ...
                <div class="col-xl-6">
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="border border-gray-300 border-dashed rounded  w-50 py-1 px-2 mb-3">
                            <a href=<?php echo e(url('/settlement/detail/'.$token.'/debit')); ?>
                        ...
                        <div class="border border-gray-300 border-dashed rounded  w-50 py-1 px-2 mb-3">
                            <a href=<?php echo e(url('/settlement/detail/'.$token.'/credit')); ?>
                                ...
                                <div class="d-flex flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                    ...
                                    <div class="fw-bolder fs-5 text-primary">IDR Rp. <?php echo e(number_format($sumCredit->amount_credit)); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\finance-server\resources\views/modules/reconcile/detail/index.blade.php ENDPATH**/ ?>