                ...
                <div class="col-xl-6">
                    <div class="d-flex flex-wrap align-items-center justify-content-between mb-1">
                        ...
                        {{-- @if ($priv->create)
                            <div class="d-flex justify-content-end w-50" data-kt-docs-table-toolbar="base">
                                <!--begin::Filter-->
                                <a href="#" class="btn btn-light-primary me-2 rounded-sm w-100"
                                    data-bs-toggle="modal" data-bs-target="#kt_modal_reconcile">Reconcile</a>
                                <!--end::Filter-->
                            </div>
                        @endif --}}
                    </div>
                    <div class="d-flex flex-wrap">
                        <div class="border border-gray-300 border-dashed rounded  w-50 py-1 px-2 mb-3">
                            <a href={{ url('/settlement/detail/'.$token.'/debit') }}
                        ...
                        <div class="border border-gray-300 border-dashed rounded  w-50 py-1 px-2 mb-3">
                            <a href={{ url('/settlement/detail/'.$token.'/credit') }}
                                class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                                <!--begin::Hidden-->
                                <div class="d-flex flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                    <div class="me-2">
                                    ...
                                    <div class="fw-bolder fs-5 text-primary">IDR Rp. {{ number_format($sumCredit->amount_credit) }}
                                    </div>
                                </div>
                                <!--end::Hidden-->
                            </a>
