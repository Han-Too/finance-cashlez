        ...
        <div class="row gy-3 g-xl-8">
            ...
            <div class="col-xl-6">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-3">
                    <h1 class="fw-bold text-dark text-start w-50">Total Data = {{ $countdata }} Data
                    </h1>
                ...
                <div class="d-flex flex-wrap row">
                            ...
                            <div class="d-flex justify-content-center flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
                                    <span class="fw-bolder text-gray-800 d-block fs-3">Match
                                        {{-- <div class="badge badge-success"><i class="fa-solid text-light fa-check"></i></div></span> --}}
                                        <div class="fw-bolder fs-5 text-light">{{ $match }} Data</div>
                                </div>
                            </div>
                            <!--end::Hidden-->
                        </span>
                            ...
                            <div class="d-flex justify-content-center flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
                                    <span class="fw-bolder text-gray-800 d-block fs-3">Not Match
                                        {{-- <div class="badge badge-danger"><i class="fa-solid text-light fa-xmark"></i></div></span> --}}
                                        <div class="fw-bolder fs-5 text-light">{{ $unmatch }} Data
                                        </div>
                                </div>
                            </div>
                            <!--end::Hidden-->
                    ...
                    {{-- <div class="col-4 border border-gray-300 border-dashed rounded py-1 px-2 mb-3">
                        <span class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                            <!--begin::Hidden-->
                            <div class="d-flex justify-content-center flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
                                    <span class="fw-bolder text-gray-800 d-block fs-3">Onhold</span>
                                    <div class="fw-bolder fs-5 text-primary">{{ $onhold }} Data
                                    </div>
                                </div>
                            </div>
                            <!--end::Hidden-->
                        ...
                        <span class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                            ...
                            <div class="d-flex justify-content-center flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
                                    ...
                                    <div class="fw-bolder fs-5 text-primary">Rp. {{ number_format($totalTransfer) }}
                                    </div>
                                </div>
                            </div>
                            <!--end::Hidden-->
                        ...
                        <span class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                            ...
                            <div class="d-flex justify-content-center flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
                                    ...
                                    <div class="fw-bolder fs-5 text-primary">Rp. {{ number_format($totalBankTransfer) }}
                                    </div>
                                </div>
                            </div>
                            <!--end::Hidden-->
                        ...
                        <span class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                            ...
                            <div class="d-flex justify-content-center flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
                                    ...
                                    <div class="fw-bolder fs-5 text-primary">Rp. {{ number_format($variance) }}
                                    </div>
                                </div>
                            </div>
                            <!--end::Hidden-->
                        ...
                        <span class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                            ...
                            <div class="d-flex justify-content-center flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
                                    ...
                                    <div class="fw-bolder fs-5 text-primary">Rp. {{ number_format($sales) }}
                                    </div>
                                </div>
                            </div>
                            <!--end::Hidden-->
