<div class="tab-pane fade show active" id="nav-role" role="tabpanel" aria-labelledby="nav-role-tab" tabindex="0">
    <div class="card card-flush px-10 py-6 rounded-sm">
        ...
        <!--begin::Datatable-->
        <table id="kt_datatable_role_1" class="table align-middle table-row-dashed fs-6 gy-5">
            <thead>
