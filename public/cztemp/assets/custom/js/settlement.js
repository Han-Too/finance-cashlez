...
var SUB = document.getElementById("kt_modal_new_target_submit");
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, row) {
            return ` 
                            <div class="text-bold fs-7 text-uppercase">${to_date(
                              data
                            )}</div>
                            <div class="text-bold fs-7 ">Upload By : ${
                              row.created_by
                            }</div>
                        `;
          },
        ...
        },
        {
          ...
          render: function (data, type, row) {
            return ` 
                            <div class="text-center">
                            <div class="text-bold fs-7">${to_rupiah(
                              Math.round(data)
                            )}</div>
...
//     //     // Check if the uploaded file is a valid CSV format
//     //     if (validFileTypes.includes(fileType)) {
//     //         done(); // Accept the file
//     //     } else {
//     //         done("Only CSV files are allowed."); // Reject the file with an error message
//     //     }
//     // },
//     success: function(file, response) {
//         if (response.success) {
