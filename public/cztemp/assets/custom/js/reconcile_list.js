    ...
    dt = $("#kt_datatable_example_2").DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          width: "200px",
          render: function (data, type, row) {
            if (authUserCanView == false && authUserCanDelete == false) {
              return "";
            } else if (row.status == "approved" && authUserCanView) {
              return `
                            <a href="${baseUrl}/reconcile-list/detail/${data}" class="btn btn-light-primary btn-sm" >
                                    View Detail
                            </a>
                            `;
            } else if (row.status == "approved" && authUserCanView == false) {
              return ``;
            } else {
              return `
                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="${baseUrl}/reconcile-list/detail/${data}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                                            View Details
                                        </a>
                                    </div>`
                                        : ""
